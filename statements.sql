...
SELECT COUNT(*) AS Total_Usuarios FROM usuarios_lenguajes WHERE lenguaje = "Java";



-- Ejercicio 9: Seleccionar los usuarios que no saben ningún lenguaje.
SELECT COUNT(*) AS Total_Usuarios FROM usuarios_lenguajes WHERE lenguaje = "null";
...
SELECT nombre, apellido, COUNT(lenguaje) AS total_lenguajes
FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL 
GROUP BY nombre, apellido;


-- Ejercicio 22: Encontrar el lenguaje con más caracteres.
SELECT lenguaje FROM usuarios_lenguajes ORDER BY LENGTH(lenguaje) DESC 
LIMIT 1;
...
SELECT COUNT(DISTINCT lenguaje) FROM usuarios_lenguajes WHERE edad > 25 AND lenguaje IS NOT NULL;
...
SELECT lenguaje FROM usuarios_lenguajes WHERE lenguaje LIKE 'J%' ORDER BY LENGTH(lenguaje) ASC 
LIMIT 1;
...
SELECT nombre, apellido, edad,(edad - (SELECT AVG(edad) FROM usuarios_lenguajes)) 
AS diferencia FROM usuarios_lenguajes;
...
SELECT lenguaje FROM usuarios_lenguajes ORDER BY created_at DESC LIMIT 1;
